  ...
  (let [bm-test "73	Archer	ARC-2K	Missile Boat	BM	3	8\\\"	1	6	6	-1	2	FALSE	2	FALSE	2	FALSE	0	FALSE	2	34	IF2"
    ...
    (t/testing "Sample MUL rows"
      ...
      (t/is (= (sut/parse-row (first (csv/parse-csv bm-test :delimiter \tab)))
               {:unit/abilities {:if {:value 2, :value* false, :ability/output "IF2"}}, :unit/armor {:toughness/current 6, :toughness/maximum 6, :toughness/unapplied 0}, :unit/attacks {:attack/charge {:attack/damage 0, :attack/self true}, :attack/physical {:attack/damage 3, :attack/self false}, :attack/regular {:attack/e 0, :attack/e* false, :attack/l 2, :attack/l* false, :attack/m 2, :attack/m* false, :attack/s 2, :attack/s* false}}, :unit/base-pv 34, :unit/chassis "Archer", :unit/damage {:armor {:current 6, :maximum 6}, :changes {:armor 6, :crits [], :structure 6}, :crits [], :structure {:current 6, :maximum 6}}, :unit/full-name "Archer ARC-2K", :unit/model "ARC-2K", :unit/move-modes {:move/walk 4}, :unit/mul-id 73, :unit/overheat 2, :unit/role :role/missile-boat, :unit/size 3, :unit/structure {:toughness/current 6, :toughness/maximum 6, :toughness/unapplied 0}, :unit/threshold -1, :unit/tmm 1, :unit/type :type/bm}))
      (t/is (= (sut/parse-row (first (csv/parse-csv cv-test :delimiter \tab)))
               {:unit/abilities {:if {:value 2, :value* false, :ability/output "IF2"}, :srch {:ability/output "SRCH"}, :tur {:ability/output "TUR(1/1/1)"}, :attack/lrm {:l 2, :l* false, :m 2, :m* false, :s 1, :s* false, :ability/output "LRM1/2/2"}, :attack/rear {:l 0, :l* false, :m 0, :m* false, :s 1, :s* false, :ability/output "REAR1/-/-"}}, :unit/armor {:toughness/current 6, :toughness/maximum 6, :toughness/unapplied 0}, :unit/attacks {:attack/charge {:attack/damage 0, :attack/self true}, :attack/lrm {:attack/e 0, :attack/e* false, :attack/l 2, :attack/l* false, :attack/m 2, :attack/m* false, :attack/s 1, :attack/s* false}, :attack/physical {:attack/damage 4, :attack/self false}, :attack/rear {:attack/e 0, :attack/e* false, :attack/l 0, :attack/l* false, :attack/m 0, :attack/m* false, :attack/s 1, :attack/s* false}, :attack/regular {:attack/e 0, :attack/e* false, :attack/l 3, :attack/l* false, :attack/m 5, :attack/m* false, :attack/s 4, :attack/s* false}}, :unit/base-pv 37, :unit/chassis "Puma Assault Tank", :unit/damage {:armor {:current 6, :maximum 6}, :changes {:armor 6, :crits [], :structure 5}, :crits [], :structure {:current 5, :maximum 5}}, :unit/full-name "Puma Assault Tank PAT-001", :unit/model "PAT-001", :unit/move-modes {:move/t 3}, :unit/mul-id 4879, :unit/overheat 0, :unit/role :role/none, :unit/size 4, :unit/structure {:toughness/current 6, :toughness/maximum 6, :toughness/unapplied 0}, :unit/threshold -1, :unit/tmm 1, :unit/type :type/cv}))
      (t/is (= (sut/parse-row (first (csv/parse-csv sv-test :delimiter \tab)))
               {:unit/abilities {:bar {:ability/output "BAR"}, :ee {:ability/output "EE"}, :ene {:ability/output "ENE"}}, :unit/armor {:toughness/current 1, :toughness/maximum 1, :toughness/unapplied 0}, :unit/attacks {:attack/charge {:attack/damage 0, :attack/self true}, :attack/physical {:attack/damage 2, :attack/self false}, :attack/regular {:attack/e 0, :attack/e* false, :attack/l 0, :attack/l* false, :attack/m 0, :attack/m* false, :attack/s 0, :attack/s* false}}, :unit/base-pv 6, :unit/chassis "Air Car", :unit/damage {:armor {:current 1, :maximum 1}, :changes {:armor 1, :crits [], :structure 2}, :crits [], :structure {:current 2, :maximum 2}}, :unit/full-name "Air Car ", :unit/model "", :unit/move-modes {:move/h 11}, :unit/mul-id 3684, :unit/overheat 0, :unit/role :role/none, :unit/size 2, :unit/structure {:toughness/current 1, :toughness/maximum 1, :toughness/unapplied 0}, :unit/threshold -1, :unit/tmm 4, :unit/type :type/sv}))
      (t/is (= (sut/parse-row (first (csv/parse-csv pm-test :delimiter \tab)))
               {:unit/abilities {:unknown {:ability/output ""}}, :unit/armor {:toughness/current 1, :toughness/maximum 1, :toughness/unapplied 0}, :unit/attacks {:attack/charge {:attack/damage 0, :attack/self true}, :attack/physical {:attack/damage 1, :attack/self false}, :attack/regular {:attack/e 0, :attack/e* false, :attack/l 0, :attack/l* false, :attack/m 0, :attack/m* false, :attack/s 1, :attack/s* false}}, :unit/base-pv 10, :unit/chassis "Centaur", :unit/damage {:armor {:current 1, :maximum 1}, :changes {:armor 1, :crits [], :structure 1}, :crits [], :structure {:current 1, :maximum 1}}, :unit/full-name "Centaur 2", :unit/model "2", :unit/move-modes {:move/walk 6}, :unit/mul-id 510, :unit/overheat 0, :unit/role :role/scout, :unit/size 1, :unit/structure {:toughness/current 1, :toughness/maximum 1, :toughness/unapplied 0}, :unit/threshold -1, :unit/tmm 2, :unit/type :type/pm}))
      (t/is (= (sut/parse-row (first (csv/parse-csv ci-test :delimiter \tab)))
               {:unit/abilities {:am {:ability/output "AM"}, :car {:value 1, :ability/output "CAR4"}, :umu {:ability/output "UMU"}}, :unit/armor {:toughness/current 1, :toughness/maximum 1, :toughness/unapplied 0}, :unit/attacks {:attack/charge {:attack/damage 0, :attack/self true}, :attack/physical {:attack/damage 1, :attack/self false}, :attack/regular {:attack/e 0, :attack/e* false, :attack/l 0, :attack/l* false, :attack/m 1, :attack/m* false, :attack/s 1, :attack/s* false}}, :unit/base-pv 8, :unit/chassis "Motorized Sub Platoon", :unit/damage {:armor {:current 1, :maximum 1}, :changes {:armor 1, :crits [], :structure 1}, :crits [], :structure {:current 1, :maximum 1}}, :unit/full-name "Motorized Sub Platoon (Laser SCUBA)", :unit/model "(Laser SCUBA)", :unit/move-modes {:move/s 2}, :unit/mul-id -1, :unit/overheat 0, :unit/role :role/undetermined, :unit/size 1, :unit/structure {:toughness/current 1, :toughness/maximum 1, :toughness/unapplied 0}, :unit/threshold -1, :unit/tmm 0, :unit/type :type/ci}))
      (t/is (= (sut/parse-row (first (csv/parse-csv im-test :delimiter \tab)))
               {:unit/abilities {:bar {:ability/output "BAR"}, :bfc {:ability/output "BFC"}, :ct {:value 1, :ability/output "CT8"}, :ee {:ability/output "EE"}, :ene {:ability/output "ENE"}, :mel {:ability/output "MEL"}, :saw {:ability/output "SAW"}}, :unit/armor {:toughness/current 1, :toughness/maximum 1, :toughness/unapplied 0}, :unit/attacks {:attack/charge {:attack/damage 0, :attack/self true}, :attack/physical {:attack/damage 4, :attack/self false}, :attack/regular {:attack/e 0, :attack/e* false, :attack/l 0, :attack/l* false, :attack/m 0, :attack/m* false, :attack/s 0, :attack/s* false}}, :unit/base-pv 7, :unit/chassis "Lumberjack", :unit/damage {:armor {:current 1, :maximum 1}, :changes {:armor 1, :crits [], :structure 5}, :crits [], :structure {:current 5, :maximum 5}}, :unit/full-name "Lumberjack LM1/A", :unit/model "LM1/A", :unit/move-modes {:move/walk 3}, :unit/mul-id 4545, :unit/overheat 0, :unit/role :role/ambusher, :unit/size 3, :unit/structure {:toughness/current 1, :toughness/maximum 1, :toughness/unapplied 0}, :unit/threshold -1, :unit/tmm 1, :unit/type :type/im}))
      (t/is (= (sut/parse-row (first (csv/parse-csv ba-test :delimiter \tab)))
               {:unit/abilities {:am {:ability/output "AM"}, :car {:value 1, :ability/output "CAR4"}, :mec {:ability/output "MEC"}, :rcn {:ability/output "RCN"}, :rsd {:value 1, :ability/output "RSD1"}}, :unit/armor {:toughness/current 1, :toughness/maximum 1, :toughness/unapplied 0}, :unit/attacks {:attack/charge {:attack/damage 0, :attack/self true}, :attack/physical {:attack/damage 1, :attack/self false}, :attack/regular {:attack/e 0, :attack/e* false, :attack/l 0, :attack/l* false, :attack/m 0, :attack/m* false, :attack/s 1, :attack/s* false}}, :unit/base-pv 15, :unit/chassis "Elemental Battle Armor", :unit/damage {:armor {:current 1, :maximum 1}, :changes {:armor 1, :crits [], :structure 2}, :crits [], :structure {:current 2, :maximum 2}}, :unit/full-name "Elemental Battle Armor (Headhunter)(Sqd4)", :unit/model "(Headhunter)(Sqd4)", :unit/move-modes {:move/jump 3, :move/walk 3}, :unit/mul-id 952, :unit/overheat 0, :unit/role :role/ambusher, :unit/size 1, :unit/structure {:toughness/current 1, :toughness/maximum 1, :toughness/unapplied 0}, :unit/threshold -1, :unit/tmm 1, :unit/type :type/ba})))))
...
(t/deftest test-get-units
  (t/testing "Get units for scenarios."
    ...
    (t/is (= (sut/get-unit "Firestarter FS9-H")
             {:unit/abilities {:attack/ht {:l 0, :l* false, :m 0, :m* false, :s 1, :s* false, :ability/output "HT1/-/-"}, :attack/rear {:l 0, :l* false, :m 0, :m* false, :s 0, :s* true, :ability/output "REAR0*/-/-"}}, :unit/armor {:toughness/current 3, :toughness/maximum 3, :toughness/unapplied 0}, :unit/attacks {:attack/charge {:attack/damage 0, :attack/self true}, :attack/ht {:attack/e 0, :attack/e* false, :attack/l 0, :attack/l* false, :attack/m 0, :attack/m* false, :attack/s 1, :attack/s* false}, :attack/physical {:attack/damage 1, :attack/self false}, :attack/rear {:attack/e 0, :attack/e* false, :attack/l 0, :attack/l* false, :attack/m 0, :attack/m* false, :attack/s 0, :attack/s* true}, :attack/regular {:attack/e 0, :attack/e* false, :attack/l 0, :attack/l* false, :attack/m 1, :attack/m* false, :attack/s 2, :attack/s* false}}, :unit/base-pv 20, :unit/chassis "Firestarter", :unit/damage {:armor {:current 3, :maximum 3}, :changes {:armor 3, :crits [], :structure 3}, :crits [], :structure {:current 3, :maximum 3}}, :unit/full-name "Firestarter FS9-H", :unit/model "FS9-H", :unit/move-modes {:move/jump 6, :move/walk 6}, :unit/mul-id 1096, :unit/overheat 0, :unit/role :role/scout, :unit/size 1, :unit/structure {:toughness/current 3, :toughness/maximum 3, :toughness/unapplied 0}, :unit/threshold -1, :unit/tmm 2, :unit/type :type/bm}))
