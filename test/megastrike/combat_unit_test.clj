...
(t/deftest test-get-units
  (t/testing "Get units for scenarios."
    ...
    (t/is (= (sut/get-unit "Firestarter FS9-H")
             {:unit/abilities
              {:attack/ht {:l 0, :l* false, :m 0, :m* false, :s 1, :s* false, :ability/output "HT1/-/-"},
               :attack/rear {:l 0, :l* false, :m 0, :m* false, :s 0, :s* true, :ability/output "REAR0*/-/-"}},
              :unit/armor {:toughness/current 3, :toughness/maximum 3, :toughness/unapplied 0},
              :unit/attacks
              {:attack/charge {:attack/damage 0, :attack/self true, :attack/type :attack/charge},
               :attack/ht {:attack/e 0, :attack/e* false, :attack/l 0, :attack/l* false, :attack/m 0, :attack/m* false, :attack/s 1, :attack/s* false},
               :attack/physical {:attack/damage 1, :attack/self false, :attack/type :attack/physical},
               :attack/rear {:attack/e 0, :attack/e* false, :attack/l 0, :attack/l* false, :attack/m 0, :attack/m* false, :attack/s 0, :attack/s* true},
               :attack/regular {:attack/e 0, :attack/e* false, :attack/l 0, :attack/l* false, :attack/m 1, :attack/m* false, :attack/s 2, :attack/s* false}},
              :unit/base-pv 20,
              :unit/chassis "Firestarter",
              :unit/full-name "Firestarter FS9-H",
              :unit/model "FS9-H",
              :unit/move-modes {:move/jump 6, :move/walk 6},
              :unit/mul-id 1096,
              :unit/overheat 0,
              :unit/role :role/scout,
              :unit/size 1,
              :unit/structure {:toughness/current 3, :toughness/maximum 3, :toughness/unapplied 0},
              :unit/threshold -1,
              :unit/tmm 2,
              :unit/type
              :type/bm}))))
